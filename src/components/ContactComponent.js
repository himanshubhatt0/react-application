...
class  Contact extends Component
{
    ...
    handleInputChange(event)
    {
        ...
        const value=target.type==='cheakbox' ? target.cheacked : target.value;
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.email && email.split('').filter(x=> x ==='@').length !==1)
          error.email="email shouldcontain @ sign";
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                                ...
                                <Col md={{size:6,offset:2}}>
                                    <FormGroup cheak>
                                        <Label cheak>
                                            ...
                                            <strong>May we contect you?</strong>
                                        </Label>
                                    </FormGroup>
                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="feedback" name="massage" rows="12" value={this.state.massage} onChange={this.handleInputChange}/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
